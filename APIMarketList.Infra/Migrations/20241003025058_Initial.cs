        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingListItem_Product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuantityPurchased = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingPurchase", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoppingPurchase_ShoppingListItem_ShoppingListItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingPurchase_ShoppingListItemId",
                table: "ShoppingPurchase",
